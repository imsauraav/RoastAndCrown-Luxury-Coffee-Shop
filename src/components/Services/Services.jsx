...
//               Best Coffee For You {/* Original heading text */}
//             </h1>
//           </div>
...
//                   <p className="text-gray-500 group-hover:text-white transition-all duration-300 text-sm line-clamp-4">
//                     {service.description}
//                   </p>
//                 </div>
//               </div>
...
const Services = () => {
  const [orderMessage, setOrderMessage] = useState({}); // store message per card
